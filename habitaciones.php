            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h4><?php echo "Habitaciones en uso:".round($uso,3)."%"?></h4>
                <h4><?php echo "Habitaciones no utilizadas:".round($noUso,3)."%"?></h4>
                <br>
                <h4>¿Invetir en este hotel? : <?php if($uso>=70) echo "SI"; else echo "NO"; ?></h4>
                    </div><!-- /# column -->
